...
#include <imgui.h>
#include "Platform/ImGui/ImGui_IMPL.h"
...
namespace Hazel
{
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispacher.Dispatch<MouseMoveEvent>(HZ_BIND_EVENT_FN(ImGuiLayer::OnMouseMovedEvent));
	...
	bool ImGuiLayer::OnKeyPressedEvent(KeyPressedEvent& e)
	{
        ...
        ImGuiKey key = KeyToImGuiKey(e.GetKeyCode());
        io.AddKeyEvent(key, true);

        HZ_CORE_ERROR("{0} => {1}", e.GetKeyCode(), KeyToImGuiKey(e.GetKeyCode()));
	...
	{
		ImGuiIO& io = ImGui::GetIO();
        unsigned int keyCode = e.GetKeyChar();
